...
impl FromRequest for AuthenticatedUser {
    ...
    fn from_request(req: &HttpRequest, _payload: &mut actix_web::dev::Payload) -> Self::Future {
        ...
        Box::pin(async move {
            let (Some(ts), Some(token)) = (token_service, raw_token) else {
