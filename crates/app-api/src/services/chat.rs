    ...
    async fn build_system_prompt(
        ...
        ctx.push_str(
            "\n## YOUR CAPABILITIES\n\
             ...
             - generate_meal_plan: Generate a completely new full-week meal plan for the user, filling all slots based on their pantry and preferences. Use this when the user doesn't have a plan and wants one. Accepts an optional 'theme' parameter for dietary requests.\n\
