...
impl MealPlanService {
    ...
    /// Add a recipe to an empty slot (creates a new slot row, or replaces an existing flex/empty one)
    pub async fn add_slot(
        ...
        // If a slot for this day+meal already exists, update it instead of inserting
        ...
        Ok(serde_json::json!({
            ...
            "servings": updated.servings_override,
